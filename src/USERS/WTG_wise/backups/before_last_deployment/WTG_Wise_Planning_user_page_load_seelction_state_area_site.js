...
useEffect(() => {
  ...
  // Log decoded and parsed cookie values for verification
  ...
  console.log("Domain ID Cookie (Decoded):", domainId);
  console.log("User Name Cookie (Decoded):", userName);
...
const handleButtonClick = () => {
  ...
  handleCardClick('Total');  
     ...
     const fetchTotalWtgCount = async () => {
      const url = new URL('http://localhost:224/api/get_total_wtg_countt');
