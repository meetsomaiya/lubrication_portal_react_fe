...
<thead>
        <tr>
          <th>Order No <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Function Loc <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Issue <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Return <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Return Percentage <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Plant <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>State <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Area <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Site <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Material <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Storage Location <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Move Type <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Material Document <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Description <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Val Type <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Posting Date <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Entry Date <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Quantity <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Order <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Order Type <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Component <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>WTG Model <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Current Oil Change Date <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>State Engineering Head <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Area Incharge <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Site Incharge <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>State PMO <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          <th>Order Status <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>
          {clickedOrderType === 'dispute' && <th>Reason <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>}
          {clickedOrderType === 'dispute' && <th>Action <FontAwesomeIcon icon={faFilter} className="filter-icon" /></th>}
        </tr>
      </thead>
  <tbody>
    {modalData &&
